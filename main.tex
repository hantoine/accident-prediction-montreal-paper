...
% The open data philosophy is the equivalent of the open source philosophy but for data. \TG{I commented this out, it is not very accurate and could lead to confusion.}
...
\TG{I don't find it very apparent. They all seem to perform similarly for high recalls, except maybe Spark RF.}
\AH{I modified the sentence, let me know what you think.}
...
of positive examples among the examples with a count of accident higher than $n$.
\TG{Do you mean a count lower than $n$? Otherwise, the probability of accidents would decrease with $n$.}
\AH{I rewrote the sentence, let me know if it is better}
...
\AH{Les références avec l'année en debut de ligne étaient les références pour lesquels j'avais utilisé le style \@online, j'ai remplacé par \@misc. Le publisher n'apparait pas pour ces références. Peut-être qu'on devrait le faire apparaitre pour donner plus de crédibilité. Voir ``Open Data 101" par exemple.}
